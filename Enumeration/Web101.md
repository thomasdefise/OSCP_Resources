...
- [Wayback Machine](https://archive.org/web/) through [gau](https://github.com/lc/gau): Getches known URLs from the the Wayback Machine
...
echo "https://victim.host.com" | subjs | python3 jsa.py
